...
public class Dish {
    ...
    public Double getDishCost() {
        double total = 0;
        for (DishIngredient di : dishIngredients) {
            if (di.getQuantity() == null) throw new RuntimeException("Some ingredients have undefined quantity");
    ...
    public Double getGrossMargin() {
        if (price == null) throw new RuntimeException("Price is null");
    ...
    @Override
    public int hashCode() { return Objects.hash(id, name, dishType); }
